...
const refactoringProvider_1 = require("./providers/refactoringProvider");
...
const refactoringProvider = new refactoringProvider_1.RefactoringProvider(docManager);
...
connection.onDocumentFormatting((params) => formatter.format(documents.get(params.textDocument.uri), params.options));
connection.onRenameRequest((params) => refactoringProvider.rename(params));
